...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        if (isset($_GET['photo_id'])) {
            $selectedPhotoId = $_GET['photo_id'];


            $select_query = "SELECT * from photos WHERE id = $selectedPhotoId";
        ...
        ?>
            ...
            <div class="row tm-mb-90">
                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                    <img src="./admin/<?php echo $row['image_path']; ?>" alt="Image" class="img-fluid">
                </div>
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                    <div class="tm-bg-gray tm-video-details">
                        ...
                        <div class="mb-4 d-flex flex-wrap">
                            <div class="mr-4 mb-2">
                                <span class="tm-text-gray-dark">Dimension: </span><span class="tm-text-primary"><?php echo $row['dimension']; ?></span>
                            </div>
                            <div class="mr-4 mb-2">
                                <span class="tm-text-gray-dark">Format: </span><span class="tm-text-primary"><?php echo $row['format']; ?></span>
                            </div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div>
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $row) {
                                    ...
                                    echo '<a href="#" class="tm-text-primary mr-4 mb-2 d-inline-block">' . $row['category_name'] . '</a>';
                                }
                            } else {
                                echo "No Data Found";
                            }
       ...
       <?php
        if (isset($_GET['category_id'])) {
            ...
            $select_query = "SELECT * from photos WHERE category_id = $selectedCategoryId";
            $result_query = mysqli_query($mysqli, $select_query);
            $row = mysqli_fetch_assoc($result_query);
            ...
            foreach ($result_query as $row) {
                ...
                <figure class="effect-ming tm-video-item">
                    <img src="./admin/' . $row['image_path'] . '" alt="Image" class="img-fluid">
