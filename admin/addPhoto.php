					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="addphotos_action.php" method="POST" enctype="multipart/form-data">




										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="photo_date">Photo Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="photo_date" name="photo_date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align  " for="active ">Active</label>
											<div class="checkbox">
												<label>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit"  id="add-photo-button" class="btn btn-success" name="add">Add</button>
											</div>
										</div>
