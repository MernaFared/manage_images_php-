            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-desktop"></i> Photos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="addPhoto.php">Add Photos</a></li>
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td><a href='editPhoto.php?id=<?php echo $row['id']; ?>'><img src="./images/edit.png" alt="Edit"></a></td>
                                  <td> <a href='deletePhoto.php' data-action="delete" data-id="<?php echo $row['id']; ?>">
