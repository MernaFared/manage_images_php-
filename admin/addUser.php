					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="addUsers_action.php">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="registeration_date"> Registeration Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="registeration_date" name="registeration_date" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="active" class="flat" value="1">
												</label>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" id="add-user-button" name="add-user-button" class="btn btn-success">Add</button>
											</div>
										</div>
