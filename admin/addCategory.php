			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div class="sidebar-footer hidden-small">
						...
						<a data-toggle="tooltip" data-placement="top" title="Logout" href="/admin/login.php">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="addCategories_action.php">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="add-category">Add Tag <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" name="add-category" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="button" id="add-category-button" name="add-category-button" class="btn btn-success">Add</button>
											</div>
										</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#add-category-button").click(function() {
				...
				$.ajax({
					type: "POST",
					url: "addcategories_action.php", // PHP script to handle the form data
					data: {
						category: category
					},
					success: function(response) {
						if (response === "success") {
							...
							// Display an error toast message if needed
							toastr.error("Category addition failed");
						}
					}
				});
			});
