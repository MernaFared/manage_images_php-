 					...
 					<div class="row">
 						<div class="col-md-12 col-sm-12 ">
 							<div class="x_panel">
 								...
 								<div class="x_content">
 									<br />
 									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="updateCategory.php" method="POST">
 										<?php
										$category_id = $_GET['id'];
											if (isset($_GET['id'])) {
												$sql_query = "SELECT * from categories Where id ='$category_id'";
											...
											?>
 											...
 											<div class="item form-group">
 												...
 												<div class="col-md-6 col-sm-6 ">
 													<input type="text" id="add-category" required="required" class="form-control" name="category_name" value="<?=$row['category_name'];?>">
